...
public class CarMoto extends javax.swing.JFrame {
    ...
    public void DoConnect() {
        try 
        {
            ...
            String uName = "rentuser";
            String uPass = "userrent";
    ...
    private void initComponents() {
        ...
        textManufacturer.setText("Honda");
        textManufacturer.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textManufacturerActionPerformed(evt);
            }
        });

        textModel.setText("Civic");

        textAvailability.setText("ναι");
        ...
        textType.setText("Αυτοκίνητο");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel1.setText("Διαθεσιμότητα οχήματος:");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setText("Τύπος οχήματος:");

        jLabel3.setText("Μηχ.Λογ. 2014");
    ...
    private void textManufacturerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textManufacturerActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textManufacturerActionPerformed
